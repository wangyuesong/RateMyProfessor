...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('lastreplytime')); ?>:</b>
	<?php echo CHtml::encode($data->lastreplytime); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('clicktime')); ?>:</b>
